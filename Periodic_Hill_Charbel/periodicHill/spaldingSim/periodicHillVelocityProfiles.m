...
% controlDict) - was '0.08', an early, barely-past-the-initial-transient instant
% under the OLD (wrong) endTime=0.5 convention.
timeName = '2000';
...
% UMean (fieldAverage'd), not instantaneous U - see system/functions' own
% comment on why an instantaneous LES snapshot isn't a fair comparison against
% Spalding's law, which describes the converged mean flow.
