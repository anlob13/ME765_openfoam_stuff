...
#include "mlNutUWallFunctionTest.H"
...
void mlNutUWallFunctionFvPatchScalarField::ensureOutputFields() const
{
...
void mlNutUWallFunctionFvPatchScalarField::setOutputField
(
    const word& fieldName,
    const label patchi,
    const label facei,
...
void mlNutUWallFunctionFvPatchScalarField::setClassifierWeightFields
(
    const label patchi,
    const label facei,
...
tmp<scalarField> mlNutUWallFunctionFvPatchScalarField::nut() const
{
    ...
    forAll(nutw, facei)
    {
       //Top face values
        ...
        const scalar tw_n_prediction = max(scalar(0), values.twMean);
