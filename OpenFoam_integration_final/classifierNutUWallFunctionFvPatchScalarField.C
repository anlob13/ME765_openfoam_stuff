...
#include "classifierNutUWallFunctionFvPatchScalarField.H"
...
namespace Foam
{
    ...
    void classifierNutUWallFunctionFvPatchScalarField::ensureOutputFields() const
    {
    ...
    void classifierNutUWallFunctionFvPatchScalarField::setOutputField(
        const word &fieldName,
        const label patchi,
        const label facei,
    ...
    void classifierNutUWallFunctionFvPatchScalarField::setClassifierWeightFields(
        const label patchi,
        const label facei,
    ...
    tmp<scalarField> classifierNutUWallFunctionFvPatchScalarField::nut() const
    {
        ...
        forAll(nutw, facei)
        {
            ...
            classifierWallModel::Prediction values = classifierModel_->predict(inputs);
            ...
            // no separate combination needed here, classifierWallModel::predict()
    ...
    tmp<scalarField> classifierNutUWallFunctionFvPatchScalarField::yPlus(
    ...
    void classifierNutUWallFunctionFvPatchScalarField::buildSecondLayerAddressing() const
    {
        const fvMesh &mesh = patch().boundaryMesh().mesh();
    ...
    void classifierNutUWallFunctionFvPatchScalarField::buildTopFaceAddressing() const
    {
        const fvMesh &mesh = patch().boundaryMesh().mesh();
        const labelUList &faceCells = patch().faceCells();
    ...
    scalar classifierNutUWallFunctionFvPatchScalarField::topFaceValue(
    ...
    vector classifierNutUWallFunctionFvPatchScalarField::topFaceValueVector(
    ...
    void classifierNutUWallFunctionFvPatchScalarField::ensureSurfaceCoordinate() const
    {
        if (sValid_)
        {
            return;
    ...
    classifierNutUWallFunctionFvPatchScalarField::classifierNutUWallFunctionFvPatchScalarField(
        const fvPatch &p,
        ...
        : nutWallFunctionFvPatchScalarField(p, iF, dict),
          ...
          //  still an autoPtr<classifierWallModel> with the same external interface).
          classifierModel_(new classifierWallModel(this->db().time().constant() / "wallModel_full" / "wallModel_classifier")),
          secondLayerCell_(),
    ...
    classifierNutUWallFunctionFvPatchScalarField::classifierNutUWallFunctionFvPatchScalarField(
        const classifierNutUWallFunctionFvPatchScalarField &ptf,
        const fvPatch &p,
        const DimensionedField<scalar, volMesh> &iF,
    ...
    classifierNutUWallFunctionFvPatchScalarField::classifierNutUWallFunctionFvPatchScalarField(
        const classifierNutUWallFunctionFvPatchScalarField &sawfpsf,
        const DimensionedField<scalar, volMesh> &iF)
    ...
    tmp<scalarField> classifierNutUWallFunctionFvPatchScalarField::yPlus() const
    {
        const label patchi = patch().index();
    ...
    void classifierNutUWallFunctionFvPatchScalarField::write(Ostream &os) const
    {
